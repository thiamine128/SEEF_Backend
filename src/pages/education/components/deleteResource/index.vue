<template>
    <div class="submit-homework-container">
        <button class="first-button" @click="showSubmitHomeworkPage">删除资源</button>
...
<!--                        <label for="filename">文件名:</label>-->
                        <input placeholder="请输入文件名" type="text" id="filename" v-model="filename" required>
                    </div>
...
<script>
import {deleteResourceAPI} from "@/pages/education/components/deleteResource/api/api";
import LeftButton from "@/pages/blog/components/leftButton/index.vue";

import store from "@/store/store";
export default {
    name: "deleteResourceButton",
    ...
    methods: {
        ...
        deleteResource(event){
            deleteResourceAPI(this.currentDirectory,this.courseId,this.filename);
        },
